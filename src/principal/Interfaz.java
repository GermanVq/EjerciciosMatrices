...
public class Interfaz extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 80, 350, 60));
    ...
    private void cmdOperacionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdOperacionActionPerformed
        ...
        switch (op) {
            case 0:
            Helper.diagonalSec(tblTablaInicial, tblTablaResultado);
            break;
            case 1:
            Helper.triangularSup(tblTablaInicial, tblTablaResultado);
            break;
            case 2:
            Helper.triangularInf(tblTablaInicial, tblTablaResultado);
            break;
            case 3:
